    ...
    def document
      {
        ...
        date_of_registration: specialist.date_of_registration,
        ...
        file_number: specialist.file_number,
        ...
        product_type: specialist.product_type,
        public_timestamp: common_fields.public_timestamp,
        register_type: specialist.register_type,
